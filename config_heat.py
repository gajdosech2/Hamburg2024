...
train_annotations_file = "coco_annotations_more.json"
test_annotations_file = "coco_annotations_more.json"
train_images_dir = ""
test_images_dir = ""
...
default_hooks = dict(
    ...
    checkpoint=dict(type=CheckpointHook, interval=checkpoint_interval, max_keep_ckpts=5)
)
env_cfg = dict(
